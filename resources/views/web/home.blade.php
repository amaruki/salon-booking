    ...
    <div class="relative">
            ...
            <div class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
                <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <p class="mt-4 max-w-lg sm:text-xl/relaxed">
                        Discover a World of Beauty and Elegance. Elevate Your Style at Salon Bliss, Where Dreams Become
                        Reality.
                    </p>
                    ...
                    @foreach ($deals as $deal)
                        @if ($deal->is_hidden == false)
                            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow ">
                                <a href="#">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">{{ $deal->name }}
                                    </h5>
                                </a>
                ...
                <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
                    <div class="mb-12 md:mb-0">
                        ...
                        <p class="mb-4 text-neutral-500">
                            ...
                            I had the most amazing experience at Salon Bliss! The staff were so friendly and welcoming,
                    ...
                    <div class="mb-12 md:mb-0">
                        ...
                        <p class="mb-4 text-neutral-500">
                            ...
                            "I had the best haircut of my life at Salon Bliss! The stylist listened to exactly what I
                    ...
                    <div class="mb-0">
                        ...
                        <p class="mb-4 text-neutral-500">
                            ...
                            "I had a last-minute hair emergency and Salon Bliss saved the day! The staff were able to
        ...
        <footer class="bg-pink-500 text-center text-neutral-100 lg:text-left">
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="">
                        ...
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Hair</a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Nails</a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Skin</a>
                        </p>
                        <p>
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Makeup</a>
                        </p>
                    </div>
                    <!-- Promotions section -->
                    <div class="">
                        ...
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Special Offers</a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Loyalty Program</a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200">Loyalty teirs</a>
                        </p>
            ...
            <div class="bg-white p-2 text-center">
                ...
                <a class="font-semibold text-neutral-600" href="/">Salon Bliss</a>
            </div>
        </footer>
        <script>
