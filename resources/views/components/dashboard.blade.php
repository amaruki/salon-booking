<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div id="dashboard-grid" style="display: grid; grid-template-columns: 256px 1fr;">
            {{-- Sidebar --}}
            <div class="">
                    ...
                    <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full ">
                        ...
                        <div class="overflow-y-auto overflow-x-hidden flex-grow">
                            ...
                            <ul class="flex flex-col py-4 space-y-1">
                                ...
                                <li>
                                    <a href="/dashboard"
                                        class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-pink-500 pr-6">
                            ...
                            ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Manage Users') }}</span>
                                ...
                                ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Manage Locations') }}</span>
                        ...
                        ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Manage Appointments') }}</span>
                            ...
                            ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Manage Services') }}</span>
                                            </a>
                                        </li>
                        ...
                        ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Manage Categories') }}</span>
                                            </a>
                                        </li>
                            ...
                            ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Manage Deals') }}</span>
                                        ...
                                        <li>
                                            <a href="{{ route('cashier.history') }}"
                                                class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-pink-500 pr-6
                            {{ request()->is('dashboard/transaction-history') ? 'bg-gray-100 border-pink-500 text-gray-900 font-semibold' : '' }}
                            ">
                                                <span class="inline-flex justify-center items-center ml-4">
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span
                                                    class="ml-2 text-sm tracking-wide truncate">{{ __('Transaction History') }}</span>
                                ...
                                @else
                                    <li>
                                        <a href="{{ route('history') }}"
                                            class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-pink-500 pr-6
                                            {{ request()->is('dashboard/history') ? 'bg-gray-100 border-pink-500 text-gray-900 font-semibold' : '' }}
                                            ">
                                            <span class="inline-flex justify-center items-center ml-4">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
