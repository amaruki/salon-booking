                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td>
                                <div class="flex gap-1 mt-5">
                                    <x-button wire:click="confirmDealEdit({{ $deal->id }})"
                                        wire:loading.attr="disabled">
                                        {{ __('Edit') }}
                                    </x-button>
                                    <x-danger-button wire:click="confirmDealDeletion({{ $deal->id }})"
                                        wire:loading.attr="disabled">
                                        {{ __('Delete') }}
                                    </x-danger-button>
                                </div>
            ...
            <x-dialog-modal wire:model="confirmingDealDeletion">
                ...
                <x-slot name="footer">
                    <div class="flex gap-3">
                        <x-secondary-button wire:click="$set('confirmingDealDeletion', false)"
                            wire:loading.attr="disabled">
                            {{ __('Cancel') }}
                        </x-secondary-button>
                        <x-danger-button wire:click="deleteDeal({{ $confirmingDealDeletion }})"
                            wire:loading.attr="disabled">
                            {{ __('Delete') }}
                        </x-danger-button>
                    </div>
                ...
                <x-slot name="content">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div class="flex justify-end mt-4 gap-2">
                            <x-secondary-button wire:click="$set('confirmingDealAdd', false)"
                                wire:loading.attr="disabled">
                                {{ __('Cancel') }}
                            </x-secondary-button>
